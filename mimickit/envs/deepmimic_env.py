...
class DeepMimicEnv(char_env.CharEnv):
    def __init__(self, env_config, engine_config, num_envs, device, visualize, record_video=False):
        ...
        self._motion_root_offset = torch.tensor(env_config.get("motion_root_offset", [0.0, 0.0, 0.0]),
    ...
    def _reset_ref_motion(self, env_ids):
        ...
        self._ref_root_pos[env_ids] = root_pos + self._motion_root_offset
    ...
    def _update_ref_motion(self):
        ...
        self._ref_root_pos[:] = root_pos + self._motion_root_offset
